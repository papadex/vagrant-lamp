...
(defvar my-packages '(auto-complete autopair markdown-mode ido-ubiquitous ess ruby-tools ruby-mode ruby-end inf-ruby flymake flymake-ruby flymake-shell flycheck org-magit auctex clojure-mode coffee-mode jabber jira deft gist haml-mode haskell-mode magit paredit projectile python-mode sass-mode scss-mode yaml-mode yari yasnippet confluence)
...
;(add-to-list '/home/vagrant/.emacs.d/python-environment.el')
